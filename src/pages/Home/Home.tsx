    ...
    <div id="content-border">
      <div id="content-holder">
        ...
        <div className="right-cont">
          ...
          <p>
            Before transitioning into software engineering, I conducted <strong>research</strong> on AI in education, <strong>co-authoring</strong> studies that explored student engagement with AI-driven learning tools. As part of CP-LEADS, a fellowship that prepares students for Ph.D. programs, I developed experience in <strong>data analytics using R</strong>. My work involved analyzing user engagement patterns, applying <strong>Natural Language Processing (NLP) techniques</strong>, and creating visual models to interpret data trends in educational research.
          </p>

          <p>
            In my spare time, I enjoy playing video games whenever possible. I used to stream my games on twitch, but now I find myself simply enjoying 1 or 2 games whenever I get the chance. I am also involved in the stock market, if not financially than simply intellectually. My favorite small talk is talking about the current market and strategies to ride whichever wave we are in.
          </p>
        </div>
      </div>
    </div>
